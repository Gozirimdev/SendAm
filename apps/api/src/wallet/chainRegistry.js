// Chain-adapter registry. Product code (payment orchestrator, WhatsApp
// assistant, admin reporting) resolves an adapter by name and never imports
// a chain SDK directly — see ARCHITECTURE.md for the interface every
// adapter implements.
