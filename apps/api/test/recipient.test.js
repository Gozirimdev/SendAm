...
test('resolves a raw chain public key directly (uppercased), no alias', () => {
...
test('resolves a saved chain alias to its stored public key and chain', () => {
  const user = { contacts: [{ alias: 'ada', publicKey: VALID_KEY, chain: 'chain' }] };
...
test('a contact saved before the chain field existed defaults to chain', () => {
