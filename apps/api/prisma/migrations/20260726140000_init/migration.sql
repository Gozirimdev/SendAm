...
--
-- The incremental migration chain up to this point was collapsed into a single
-- baseline. Databases created before it predate this chain and must be reset:
-- this project is testnet-only, and wallet provisioning is lazy, so users are
-- re-provisioned through sendam-custody on their next message.
...
CREATE TABLE "User" (
    ...
    "pendingFlow" JSONB,
    "contactsJson" JSONB,
    "awaitingGetStartedUntil" TIMESTAMP(3),
    "registrationToken" TEXT,
    "registrationTokenExpiresAt" TIMESTAMP(3),
    "termsAcceptedAt" TIMESTAMP(3),
    "pendingWebauthnChallenge" TEXT,
...
CREATE TABLE "Wallet" (
    ...
    "userId" TEXT NOT NULL,
    "phoneNumber" TEXT,
    "provider" TEXT NOT NULL DEFAULT 'custody',
    "providerWalletId" TEXT,
    "address" TEXT,
    "publicKey" TEXT,
    "primaryChain" TEXT NOT NULL DEFAULT 'lisk',
    "supportedChains" TEXT[] DEFAULT ARRAY['lisk']::TEXT[],
    "network" TEXT NOT NULL DEFAULT 'custody',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
